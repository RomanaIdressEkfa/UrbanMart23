...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::post('/bulk-customer-delete', 'bulk_customer_delete')->name('bulk-customer-delete');
         // --- নতুন দুটি রাউট এখানে যোগ করুন ---
    Route::get('/customers/list/suspicious', 'suspicious_customers')->name('customers.suspicious_list');
    Route::get('/customers/list/banned', 'banned_customers')->name('customers.banned_list');
    });
    ...
    Route::controller(ShippingChargeController::class)->group(function () {
        ...
        Route::post('/shipping-charge/update', 'update')->name('shipping_charge.update');
    });
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/completed-orders', 'completed_orders')->name('completed_orders.index');
        ...
        Route::post('/orders/delivery-boy-assign', 'assign_delivery_boy')->name('orders.delivery-boy-assign');
          ...
          // Order bulk export
        Route::get('/order-bulk-export', 'orderBulkExport')->name('orders.bulk_export');
        Route::post('/bulk-unpaid-order-payment-notification', 'unpaid_order_payment_notification')->name('bulk-unpaid-order-payment-notification');
        Route::post('/order-payment-notification', 'unpaid_order_payment_notification')->name('unpaid-order-payment-notification');
    });
    ...
    // Pre-Order Management Routes
    Route::controller(App\Http\Controllers\Admin\PreorderManagementController::class)->group(function () {
        Route::get('/preorder-management', 'index')->name('preorder_management.index');
        Route::get('/preorder-management/dashboard', 'dashboard')->name('preorder_management.dashboard');
        Route::get('/preorder-management/customers', 'customers')->name('preorder_management.customers');
        Route::get('/preorder-management/customers/{id}/details', 'customerDetails')->name('preorder_management.customers.details');
        Route::get('/preorder/products/all', 'allPreorderProducts')->name('admin.preorder.products.all');
        Route::get('/preorder/customers', 'preorderCustomers')->name('admin.preorder.customers');
        Route::get('/preorder/payments/advance', 'preorderPaymentsAdvance')->name('admin.preorder.payments.advance');
        Route::get('/preorder/delivery/schedule', 'deliveryScheduleBalance')->name('admin.preorder.delivery.schedule');
        Route::post('/preorder/products/update-status', 'updateProductStatus')->name('admin.preorder.products.update_status');
        Route::post('/preorder/customers/update-status', 'updateCustomerStatus')->name('admin.preorder.customers.update_status');
        Route::post('/preorder/payments/process-advance', 'processAdvancePayment')->name('admin.preorder.payments.process_advance');
        Route::post('/preorder/delivery/update-schedule', 'updateDeliverySchedule')->name('admin.preorder.delivery.update_schedule');
        Route::post('/preorder/delivery/mark-delivered', 'markAsDelivered')->name('admin.preorder.delivery.mark_delivered');
        Route::post('/preorder/delivery/bulk-update', 'bulkUpdateDelivery')->name('admin.preorder.delivery.bulk_update');
        Route::post('/preorder/products/update-status', 'updateProductStatus')->name('admin.preorder.products.update_status');
        Route::post('/preorder/products/update-preorder-status', 'updatePreorderStatus')->name('admin.preorder.products.update_preorder_status');
        Route::post('/preorder/products/update-published-status', 'updatePublishedStatus')->name('admin.preorder.products.update_published_status');
        Route::post('/preorder/products/update-featured-status', 'updateFeaturedStatus')->name('admin.preorder.products.update_featured_status');
        Route::post('/preorder/products/update-preorder-price', 'updatePreorderPrice')->name('admin.preorder.products.update_preorder_price');
        Route::post('/preorder/customers/get-details', 'getCustomerDetails')->name('admin.preorder.customers.get_details');
        Route::post('/preorder/customers/update-status', 'updateCustomerStatus')->name('admin.preorder.customers.update_status');
          Route::get('/preorder/destroy/{order_code}', 'destroy_preorder')->name('preorder.destroy');
        
        // New comprehensive tracking routes
        Route::post('/preorder-management/update-payment', 'updatePayment')->name('preorder_management.update_payment');
        Route::post('/preorder-management/update-delivery', 'updateDelivery')->name('preorder_management.update_delivery');
        Route::post('/preorder-management/update-status', 'updateStatus')->name('preorder_management.update_status');
        
        // Pre-order Product Management - Flash Deal Style
        Route::get('/preorder-management/products', 'preorderProductManagement')->name('preorder_management.products');
        Route::post('/preorder-management/products/update', 'updatePreorderProduct')->name('preorder_management.products.update');
        Route::get('/preorder-management/products/list', 'getPreorderProducts')->name('preorder_management.products.list');
        Route::get('/preorder-management/notifications', 'getPreorderNotifications')->name('preorder_management.notifications');
    });
