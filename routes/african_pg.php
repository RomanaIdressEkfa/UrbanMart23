...
// Mohammad Hassan - Commented out AfricanPaymentGatewayController as controller doesn't exist
// use App\Http\Controllers\AfricanPaymentGatewayController;
// Mohammad Hassan - Commented out FlutterwaveController as controller doesn't exist
// use App\Http\Controllers\Payment\FlutterwaveController;
// Mohammad Hassan - Commented out MpesaController as controller doesn't exist
// use App\Http\Controllers\Payment\MpesaController;
// Mohammad Hassan - Commented out PayfastController as controller doesn't exist
// use App\Http\Controllers\Payment\PayfastController;

// Mohammad Hassan - Commented out AfricanPaymentGatewayController route group as controller doesn't exist
/*
...
*/
//Mpesa
// Mohammad Hassan - Commented out MpesaController route group as controller doesn't exist
/*
...
// Mohammad Hassan - Commented out FlutterwaveController route as controller doesn't exist
// Route::get('/rave/callback', [FlutterwaveController::class, 'callback'])->name('flutterwave.callback');

// RaveController end

//Payfast routes <starts>
// Mohammad Hassan - Commented out PayfastController route group as controller doesn't exist
/*
Route::controller(PayfastController::class)->group(function () {
  ...
  Route::any('/payfast/customer_package_payment/return', 'customer_package_payment_return')->name('payfast.customer_package_payment.return');
  Route::any('/payfast/customer_package_payment/cancel', 'customer_package_payment_cancel')->name('payfast.customer_package_payment.cancel');
});
*/
//Payfast routes <ends>
