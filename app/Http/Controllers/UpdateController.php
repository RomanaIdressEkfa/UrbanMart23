...
class UpdateController extends Controller
{
    public function step0(Request $request)
    {
        ...
        if (version_compare($current_version, '9.7', '<')) {
    ...
    {
        $versions = ['9.7'=>'v970.sql','9.8'=>'v980.sql','9.8.1'=>'v981.sql' ,'9.9'=>'v990.sql','9.9.1'=>'v991.sql', '9.9.2'=>'v992.sql', '9.9.3'=>'v993.sql', '9.9.4'=>'v994.sql', '9.9.5'=>'v995.sql', '9.9.6'=>'v996.sql','9.9.7'=>'v997.sql'];

        $keys = array_keys($versions);
        $current_version = (get_setting('current_version') != null) ? get_setting('current_version') : '9.7';
