...
class ProductController extends Controller
{
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang', 'variantImages'));
    }
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        // For variant products, calculate current_stock from variants
        if ($product->variant_product) {
            $request->merge(['current_stock' => 0]); // Set to 0 as it will be calculated from variants
        }
        ...
        // Product Translations
        $request->merge(['lang' => $request->lang ?? env('DEFAULT_LANGUAGE', 'en')]);
