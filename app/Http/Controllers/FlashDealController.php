...
class FlashDealController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($flash_deal->save()){
            ...
            $flash_deal_translation = FlashDealTranslation::firstOrNew(['lang' => env('DEFAULT_LANGUAGE', 'en'), 'flash_deal_id' => $flash_deal->id]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($flash_deal->save()){
            ...
            $langForTranslation = $request->lang ?? env('DEFAULT_LANGUAGE', 'en');
            $sub_category_translation = FlashDealTranslation::firstOrNew(['lang' => $langForTranslation, 'flash_deal_id' => $flash_deal->id]);
