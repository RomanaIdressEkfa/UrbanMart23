...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        // প্রথমে ব্যবহারকারীকে খুঁজে বের করা হচ্ছে
        $user = User::where($this->username(), $request->{$this->username()})->first();

        // চেক করা হচ্ছে ব্যবহারকারী ব্যানড কিনা
        if ($user && $user->banned) {
            return false; // যদি ব্যানড হয়, তাহলে লগইন করতে দেবে না
        }
        
        // যদি ব্যানড না হয়, তাহলে স্বাভাবিক লগইন প্রক্রিয়া চালানো হবে
    ...
    {
        // ব্যবহারকারীকে খুঁজে বের করা হচ্ছে
        $user = User::where($this->username(), $request->{$this->username()})->first();

        // যদি ব্যবহারকারী ব্যানড হয়, তাহলে একটি নির্দিষ্ট মেসেজ দেখানো হবে
        if ($user && $user->banned) {
