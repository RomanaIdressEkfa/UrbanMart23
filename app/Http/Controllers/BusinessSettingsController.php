...
class BusinessSettingsController extends Controller
{
    ...
    public function payment_method_update(Request $request)
    {
        ...
        // Keep env in sync for SSLCommerz domain selection
        if ($request->payment_method === 'sslcommerz') {
            $testMode = $request->has('sslcommerz_sandbox') ? 'true' : 'false';
            $this->overWriteEnvFile('SSLCZ_TESTMODE', $testMode);
        }
        ...
        // Clear caches so new env values are picked up by config()
