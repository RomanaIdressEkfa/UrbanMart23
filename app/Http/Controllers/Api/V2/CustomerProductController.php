...
class CustomerProductController extends Controller
{
    ...
    {   
        ...
        if($customer_product->save()){
            ...
            $customer_product_translation               = CustomerProductTranslation::firstOrNew(['lang' => env('DEFAULT_LANGUAGE', 'en'), 'customer_product_id' => $customer_product->id]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($customer_product->save()){
            ...
            $customer_product_translation               = CustomerProductTranslation::firstOrNew(['lang' => $request->lang ?? env('DEFAULT_LANGUAGE', 'en'), 'customer_product_id' => $customer_product->id]);
            $customer_product_translation->name         = $request->name;
            $customer_product_translation->unit         = $request->unit;
            $customer_product_translation->description  = $request->description;
            $customer_product_translation->save();
