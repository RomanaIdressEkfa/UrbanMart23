    ...
    <div class="card rounded-0 border">
        ...
        @foreach ($carts as $key => $cartItem)
            @php
                ...
                $item_shipping_cost = $cartItem['shipping_cost'];
                $item_tax = cart_product_tax($cartItem, $product, false) * $quantity;
                $item_subtotal = cart_product_price($cartItem, $product, false, false) * $quantity;
                ...
                $subtotal_for_min_order_amount += $item_subtotal;
                $subtotal += $item_subtotal;
                $tax += $item_tax;
                $shipping += $item_shipping_cost;
                
                if (addon_is_activated('club_point')) {
                    $total_point += $product->earn_point * $quantity;
                }
            @endphp
        @endforeach
        ...
        <div class="card-body pt-2">
            ...
            <div class="mt-4">
                ...
                @endphp
                @if(Auth::check() || $guest_checkout_enabled)
