...
<div>
    ...
    <div class="row gutters-10" style="flex-direction: column;">
        @php
            $first_payment = true;
        @endphp
            ...
            <div class="col-12">
                <label class="aiz-megabox d-block mb-3">
                    <input value="{{ $payment_method->name }}" class="online_payment" type="radio"
                        name="payment_option" {{ $first_payment ? 'checked' : '' }}>
                ...
                <div class="col-12">
                    <label class="aiz-megabox d-block mb-3">
                        <input value="cash_on_delivery" class="online_payment" type="radio"
                            name="payment_option" {{ empty(get_activate_payment_methods()) && $first_payment ? 'checked' : '' }}>
                        <span class="d-flex align-items-center justify-content-between aiz-megabox-elem rounded-0 p-3">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <label class="aiz-megabox d-block mb-3">
                            <input value="{{ $method->heading }}" type="radio"
                                ...
                                data-id="{{ $method->id }}" {{ $first_payment ? 'checked' : '' }}>
                            <span class="d-flex align-items-center justify-content-between aiz-megabox-elem rounded-0 p-3">
