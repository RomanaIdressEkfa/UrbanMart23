                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <form id="option-choice-form" class="mb-3" method="POST" action="javascript:void(0);">
                                @csrf
                            ...
                            <div class="mt-3">
                                {{-- Mohammad Hassan --}}
                                <button type="button" class="btn btn-secondary-base mr-2 add-to-cart fw-600 w-150px rounded-0 text-white" @if(Auth::check() || get_Setting('guest_checkout_activation') == 1 || get_setting('guest_checkout_active') == 1) onclick="addToCart()" @else onclick="showLoginModal()" @endif>
                                    <i class="las la-shopping-bag"></i>
                                    <span class="d-none d-md-inline-block"> {{ translate('Add to cart')}}</span>
                                </button>
                                <button type="button" class="btn btn-primary buy-now fw-600 add-to-cart w-150px rounded-0" @if(Auth::check() || get_Setting('guest_checkout_activation') == 1 || get_setting('guest_checkout_active') == 1) onclick="buyNow()" @else onclick="showLoginModal()" @endif>
