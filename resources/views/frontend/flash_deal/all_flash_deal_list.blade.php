            ...
            <section class="mb-4">
                ...
                @else
                    <div class="text-center py-5">
                        <div class="mb-4">
                            <i class="las la-frown fs-60 text-muted"></i>
                        </div>
                        <h4 class="h5 fw-700 text-dark">{{ translate('No Flash Deals Available') }}</h4>
                        <p class="text-muted mb-4">{{ translate('There are currently no active flash deals. Please check back later for exciting offers!') }}</p>
