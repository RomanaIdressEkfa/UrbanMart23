...
@section('panel_content')
    <div class="aiz-titlebar mb-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="fs-20 fw-700 text-dark">{{ translate('Complain Note') }}</h1>
            </div>
        </div>
    </div>
    ...
    <div class="p-4 mb-3 c-pointer text-center bg-light has-transition border h-100 hov-bg-soft-light" data-toggle="modal" data-target="#ticket_modal">
        ...
        <div class="fs-14 fw-600 text-dark">{{ translate('Create a Complain Note') }}</div>
    </div>

    <!-- Tickets -->
    <div class="card rounded-0 shadow-none border">
        <div class="card-header border-bottom-0">
            <h5 class="mb-0 fs-20 fw-700 text-dark text-center text-md-left">{{ translate('Complain Notes')}}</h5>
        </div>
