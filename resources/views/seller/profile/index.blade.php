                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="tel" id="phone-code-seller" class="form-control mb-3 rounded-0" placeholder="{{ translate('Your Phone Number')}}" name="phone" value="" required>
...
<script type="text/javascript">
    // Initialize intlTelInput for seller profile phone field
    $(document).ready(function() {
        var input = document.querySelector("#phone-code-seller");
        if (input) {
