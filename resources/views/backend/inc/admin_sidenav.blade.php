...
<li class="aiz-side-nav-item">
    <a href="#" class="aiz-side-nav-link">
        ...
        <span class="aiz-side-nav-text">{{ translate('Pre-Orders') }}</span>
        @if(App\Models\Preorder::where('is_viewed', 0)->distinct('order_code')->count() > 0)
            <span class="badge badge-danger badge-circle">{{ App\Models\Preorder::where('is_viewed', 0)->distinct('order_code')->count() }}</span>
        @endif
        <span class="aiz-side-nav-arrow"></span>
    </a>
    <ul class="aiz-side-nav-list level-2">
        @can('preorder_dashboard')
        <li class="aiz-side-nav-item">
            <a href="{{ route('preorder_management.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['preorder_management.index']) }}">
                <span class="aiz-side-nav-text">{{ translate('Dashboard') }}</span>
            </a>
        </li>
        @endcan
        ...
        <li class="aiz-side-nav-item">
            <a href="{{ route('admin.preorder.products.all') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.preorder.products.all']) }}">
                <span class="aiz-side-nav-text">{{ translate('All PreOrder Products') }}</span>
            </a>
        </li>
        @endcan
        ...
        <li class="aiz-side-nav-item">
            <a href="{{ route('admin.preorder.payments.advance') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.preorder.payments.advance', 'preorders.show']) }}">
                <span class="aiz-side-nav-text">{{ translate('Orders & Payments') }}</span>
            </a>
        </li>
        @endcan
    </ul>
...
{{-- নতুন দুটি মেন্যু এখানে যোগ করুন --}}
        @can('view_all_customers') {{-- আপনি চাইলে নতুন পারমিশনও তৈরি করতে পারেন --}}
        <li class="aiz-side-nav-item">
            <a href="{{ route('customers.suspicious_list') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customers.suspicious_list']) }}">
                <span class="aiz-side-nav-text">{{ translate('Suspicious Customers') }}</span>
            </a>
        </li>
        <li class="aiz-side-nav-item">
            <a href="{{ route('customers.banned_list') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customers.banned_list']) }}">
                <span class="aiz-side-nav-text">{{ translate('Banned Customers') }}</span>
            </a>
        </li>
        @endcan
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @endcan
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('shipping_charge.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['shipping_charge.index'])}}">
