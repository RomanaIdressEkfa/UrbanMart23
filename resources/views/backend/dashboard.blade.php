...
@section('content')
    ...
    @can('admin_dashboard')
        <div class="row gutters-16">
            ...
            <!-- Pre-order Statistics - Mohammad Hassan -->
            <div class="col-lg-6">
                <div class="dashboard-box bg-white mb-2rem overflow-hidden">
                    <div class="px-3 py-3">
                        <h3 class="fs-16 fw-600 text-dark mb-3">{{ translate('Pre-order Statistics') }}</h3>
                        <div class="row gutters-16">
                            <!-- Total Pre-orders -->
                            <div class="col-sm-6">
                                <div class="dashboard-box bg-soft-purple h-lg-150px mb-3 overflow-hidden">
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div>
                                            <h1 class="fs-30 fw-600 text-purple mb-1">
                                                {{ $total_preorders }}
                                            </h1>
                                            <h3 class="fs-13 fw-600 text-secondary mb-0">{{ translate('Total Pre-orders') }}</h3>
                                        </div>
                                        <a href="{{ route('preorder_management.index') }}"
                                            class="btn btn-md btn-purple btn-block rounded-2 mt-3">{{ translate('Manage Pre-orders') }}</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Pre-order Value -->
                            <div class="col-sm-6">
                                <div class="dashboard-box bg-soft-info h-lg-150px mb-3 overflow-hidden">
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div>
                                            <h1 class="fs-24 fw-600 text-info mb-1">
                                                {{ single_price($total_preorder_value) }}
                                            </h1>
                                            <h3 class="fs-13 fw-600 text-secondary mb-0">{{ translate('Total Pre-order Value') }}</h3>
                                        </div>
                                        <div class="text-info fs-12">
                                            {{ translate('Advance Paid') }}: {{ single_price($total_advance_paid) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <a href="{{ route('preorder_management.index', ['status' => 'pending']) }}"
                                    class="bg-warning rounded-2 h-90px d-flex align-items-center justify-content-between text-white px-2rem mb-3 stat-card">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-3" viewBox="0 0 20 20">
                                            <path d="M10 2a8 8 0 1 0 8 8 8 8 0 0 0-8-8zm0 14a6 6 0 1 1 6-6 6 6 0 0 1-6 6z" fill="#fff"/>
                                            <path d="M10 6a1 1 0 0 0-1 1v3a1 1 0 0 0 2 0V7a1 1 0 0 0-1-1z" fill="#fff"/>
                                        </svg>
                                        <p class="fs-13 fw-600 mb-0">{{ translate('Pending') }}</p>
                                    </div>
                                    <h1 class="fs-24 fw-600 mb-0">{{ $pending_preorders }}</h1>
                                </a>
                            </div>

                            <div class="col-sm-4">
                                <a href="{{ route('preorder_management.index', ['status' => 'confirmed']) }}"
                                    class="bg-success rounded-2 h-90px d-flex align-items-center justify-content-between text-white px-2rem mb-3 stat-card">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-3" viewBox="0 0 20 20">
                                            <path d="M10 2a8 8 0 1 0 8 8 8 8 0 0 0-8-8zm-1 11l-3-3 1.41-1.41L9 10.17l4.59-4.58L15 7l-6 6z" fill="#fff"/>
                                        </svg>
                                        <p class="fs-13 fw-600 mb-0">{{ translate('Confirmed') }}</p>
                                    </div>
                                    <h1 class="fs-24 fw-600 mb-0">{{ $confirmed_preorders }}</h1>
                                </a>
                            </div>

                            <div class="col-sm-4">
                                <a href="{{ route('preorder_management.index', ['status' => 'product_arrived']) }}"
                                    class="bg-info rounded-2 h-90px d-flex align-items-center justify-content-between text-white px-2rem mb-3 stat-card">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-3" viewBox="0 0 20 20">
                                            <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6z" fill="#fff"/>
                                        </svg>
                                        <p class="fs-13 fw-600 mb-0">{{ translate('Arrived') }}</p>
                                    </div>
                                    <h1 class="fs-24 fw-600 mb-0">{{ $arrived_preorders }}</h1>
                                </a>
                            </div>

                            <!-- This Month Stats -->
                            <div class="col-sm-6">
                                <div class="bg-soft-primary rounded-2 h-90px d-flex align-items-center justify-content-between text-primary px-2rem mb-3 stat-card">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-3" viewBox="0 0 20 20">
                                            <path d="M6 2v2H4v14h12V4h-2V2h-2v2H8V2H6zm2 4h4v2H8V6zm0 4h4v2H8v-2z" fill="#007bff"/>
                                        </svg>
                                        <p class="fs-13 fw-600 text-dark mb-0">{{ translate('This Month') }}</p>
                                    </div>
                                    <h1 class="fs-24 fw-600 mb-0">{{ $preorders_this_month }}</h1>
                                </div>
                            </div>

                            <div class="col-sm-6">
                                <div class="bg-soft-secondary rounded-2 h-90px d-flex align-items-center justify-content-between text-secondary px-2rem mb-3 stat-card">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-3" viewBox="0 0 20 20">
                                            <path d="M4 4h12v2H4V4zm0 4h12v2H4V8zm0 4h8v2H4v-2z" fill="#6c757d"/>
                                        </svg>
                                        <p class="fs-13 fw-600 text-dark mb-0">{{ translate('Month Value') }}</p>
                                    </div>
                                    <h1 class="fs-20 fw-600 mb-0">{{ single_price($preorder_value_this_month) }}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
