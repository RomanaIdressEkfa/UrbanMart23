...
@section('content')
    <div class="page-content">
        ...
        <div class="d-sm-flex">
            ...
            <!-- tab content -->
            <div class="flex-grow-1 p-sm-3  mb-2rem mb-md-0">
                <!-- Error Meassages -->
                @if ($errors->any())
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-xxl-9">
                                                    <input type="number" lang="en"
                                                        ...
                                                        name="min_qty"
                                                        value="{{ old('min_qty', $product->min_qty >= 1 ? $product->min_qty : 1) }}"
                                                        min="1" required>
                                                    <small
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" lang="en" min="0" step="0.01"
                                                placeholder="{{ translate('Discount (Optional)') }}" name="discount"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <label class="aiz-switch aiz-switch-success mb-0 d-block">
                                                <input type="checkbox" id="is_preorder_edit" name="is_preorder" value="1"
                                                    @if ($product->is_preorder == 1) checked @endif>
                                                <span></span>
                                            </label>
                                    ...
                                    <div class="form-group row @if ($product->is_preorder != 1) d-none @endif" id="preorder_percentage_block_edit">
                                        <label class="col-md-3 col-from-label">{{ translate('Pre-order Advance Payment (%)') }}</label>
                                        <div class="col-md-6">
                                            <input type="number"
                                                   name="preorder_payment_percentage"
                                                   id="preorder_payment_percentage_edit"
                                                   min="1" max="100" step="1"
                                                   value="{{ old('preorder_payment_percentage', $product->preorder_payment_percentage ?? 50) }}"
 ...
 <!-- START: DYNAMIC PRICE TIERS (WITH OLD DATA HANDLING) -->
                                    <div class="form-group row">
                                        <label
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div id="price-tier-container">
                                                @if (old('price_tiers'))
                                                    @foreach (old('price_tiers')['min_qty'] as $key => $min_qty)
                                                        <div class="row gutters-5 price-tier-row mb-3">
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-0">
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend"><span
                                                                                class="input-group-text">{{ translate('Min Qty') }}</span>
                                                                        </div>
                                                                        <input type="number"
                                                                            name="price_tiers[min_qty][]"
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="form-group mb-0">
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend"><span
                                                                                class="input-group-text">{{ translate('Price') }}</span>
                                                                        </div>
                                                                        <input type="number" lang="en"
                                                                            name="price_tiers[price][]"
                                                                            class="form-control" placeholder="0.00"
                                                                            min="0" step="0.01"
                                                                            value="{{ old('price_tiers')['price'][$key] }}"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto">
                                                                <button type="button"
                                                                    ...
                                                                    onclick="removePriceTier(this)"><i
                                            ...
                                            <button type="button" class="btn btn-soft-secondary btn-sm"
                                                onclick="addPriceTier()"><i class="las la-plus"></i>
                                                {{ translate('Add New Tier') }}</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" id="quantity">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" lang="en"
                                                value="{{ $product->variant_product ? $product->stocks->sum('qty') : optional($product->stocks->first())->qty }}"
                                                step="1" placeholder="{{ translate('Current Stock') }}"
                                                name="current_stock" class="form-control" {{ $product->variant_product ? 'readonly' : '' }}>
                                            @if($product->variant_product)
                                            <small class="text-muted">{{ translate('This is automatically calculated from variant quantities') }}</small>
                                            @endif
                                        </div>
                                    </div>
                                </div>
...
@section('script')
    ...
    <script>
        // Show/hide preorder percentage when toggle enabled on edit page
        (function() {
            function togglePreorderPercentageEdit() {
                var cb = document.getElementById('is_preorder_edit');
                var block = document.getElementById('preorder_percentage_block_edit');
                if (!cb || !block) return;
                if (cb.checked) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                var cb = document.getElementById('is_preorder_edit');
                if (cb) {
                    cb.addEventListener('change', togglePreorderPercentageEdit);
                    togglePreorderPercentageEdit();
                }
            });
        })();
    </script>
