            ...
            <tr class="variant">
                ...
                <td>
                    <input type="number" lang="en" name="price_{{ $str }}" value="@php
                           ...
                           @endphp" min="0" step="0.01" class="form-control variant-price" required>
                </td>
                <td>
                    <input type="number" lang="en" name="discount_price_{{ $str }}" value="@php
                            if($stock != null){
                                echo $stock->discount_price ?? 0;
                            }
                            else {
                                echo 0;
                            }
                           @endphp" min="0" step="0.01" class="form-control variant-discount-price" placeholder="{{ translate('Discount Price') }}">
                </td>
                <td>
