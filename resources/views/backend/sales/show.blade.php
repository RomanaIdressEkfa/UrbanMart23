    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row gutters-5">
                ...
                <div class="col text-md-left text-center">
                    @php
                        // shipping_address (JSON) থেকে তথ্য একবার ডিকোড করা হচ্ছে
                        $shipping_address = json_decode($order->shipping_address);
                    @endphp

                    @if($shipping_address)
                        {{-- অতিথি এবং রেজিস্টার্ড উভয় ব্যবহারকারীর জন্য এই ব্লকটি কাজ করবে --}}
                        <address>
                            ...
                            @if(!empty($shipping_address->city)), {{ $shipping_address->city }}@endif
                            
                            @if(!empty($shipping_address->state)), {{ $shipping_address->state }}@endif

                            @if(!empty($shipping_address->postal_code)) - {{ $shipping_address->postal_code }}@endif
                            <br>
                            
                            @if(!empty($shipping_address->country)){{ $shipping_address->country }}@endif
                        </address>
                    @elseif($order->user)
                        {{-- যদি shipping_address না থাকে কিন্তু রেজিস্টার্ড ব্যবহারকারী হন (ফলব্যাক) --}}
                        <address>
                            <strong class="text-main">
                                {{ $order->user->name }}
                            </strong><br>
                    ...
                    {{-- Manual Payment Information (অপরিবর্তিত) --}}
